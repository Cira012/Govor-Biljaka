    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <div className="bg-gradient-to-br from-emerald-50 to-amber-50 rounded-2xl shadow-md overflow-hidden mb-6 h-[900px] flex items-center justify-center p-10 relative">
            ...
            <div className="relative w-full h-full flex items-center justify-center rounded-xl overflow-hidden bg-white/50 backdrop-blur-sm p-4">
              <img 
                src={plant.image} 
                alt={plant.name}
